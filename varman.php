...
$consulta=mysql_query(' SELECT * FROM mantequilla');

?>
<ul><li><h3><a href="index.php">Pagina Principal</a></h3></li></ul>
 
<ul><li><h3><a href="mantequilla_nuevo.php">Nuevos Producto</a></h3></li></ul>
...
?>
	<tr>
		...
		<td><a href="mantequilla_editar.php?codigo=<?php echo $fila['id']?>">editar</a>
		<a href="mantequilla_eliminar.php?codigo=<?php echo $fila['id']?>">eliminar</a></td>
