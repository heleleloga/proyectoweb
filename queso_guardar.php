...
$cons=mysql_query('UPDATE queso SET Nombre="'.$nombre.'", Peso="'.$peso.'", Precio="'.$precio.'", Disponibilidad="'.$disponibilidad.'" WHERE id='.$cod);
...
<a href="varque.php">Volver al inicio</a>