...
$consulta=mysql_query(' SELECT * FROM arequipe');

?>
<ul><li><h3><a href="index.php">Pagina Principal</a></h3></li></ul>
 
<ul><li><h3><a href="arequipe_nuevo.php">Nuevos Producto</a></h3></li></ul>
...
?>
	<tr>
		...
		<td><a href="arequipe_editar.php?codigo=<?php echo $fila['id']?>">editar</a>
		<a href="arequipe_eliminar.php?codigo=<?php echo $fila['id']?>">eliminar</a></td>
