...
$cons=mysql_query('UPDATE mantequilla SET Nombre="'.$nombre.'", Peso="'.$peso.'", Precio="'.$precio.'", Disponibilidad="'.$disponibilidad.'" WHERE id='.$cod);
...
<a href="varman.php">Volver al inicio</a>