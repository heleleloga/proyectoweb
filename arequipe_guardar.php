...
$cons=mysql_query('UPDATE arequipe SET Nombre="'.$nombre.'", Peso="'.$peso.'", Precio="'.$precio.'", Disponibilidad="'.$disponibilidad.'" WHERE id='.$cod);
...
<a href="vararq.php">Volver al inicio</a>