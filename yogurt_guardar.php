...
$cons=mysql_query('UPDATE yogurt SET Nombre="'.$nombre.'", Peso="'.$peso.'", Precio="'.$precio.'", Disponibilidad="'.$disponibilidad.'" WHERE id='.$cod);
...
<a href="varyog.php">Volver al inicio</a>